...
<div id="particles-js">
    <div class="login" style="display: block;">
        ...
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="../images/cpacha.png"></div>
            <div class="login-center-input">
                ...
                <img id="cpacha-img" title="点击切换验证码" style="cursor:pointer;" src="../kaptcha.jpg" width="110px" height="30px" onclick="changeCpacha()">
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function changeCpacha(){
        $("#cpacha-img").attr("src",'../kaptcha.jpg?' + new Date().getTime());
    }
